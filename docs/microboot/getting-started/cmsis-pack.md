...
![cmsis_pack](../../images/microboot/cmsis-pack/step-01.png)
...
![cmsis_pack_2](../../images/microboot/cmsis-pack/step-02.png)
...
![cmsis_pack_3](../../images/microboot/cmsis-pack/step-04.png)

这里警告的含义是说：**ymodem_ota**依赖了其他模块，但你没有勾选它们。简单的单击左下角的 Resolve 按钮，RTE会自动帮你勾选上所依赖的模块。

![cmsis_pack_3](../../images/microboot/cmsis-pack/step-03.png)

单击“OK” 按钮完成组件的添加。

根据芯片类型选择FLASH的驱动程序：

![cmsis_pack_5](../../images/microboot/cmsis-pack/step-05.jpg)

**步骤二：配置编译环境**

如果你使用**Arm Compiler 6（armclang）**，则需要打开对**C11**和**GNU扩展**的支持，即直接在"Language C"中选择“**gnu11**”：

![cmsis_pack_6](../../images/microboot/cmsis-pack/step-06.jpg)

**步骤三：模块配置**

在工程管理器中展开 **MicroBoot**，并找到新加入的用户适配器文件（**user_app_cfg.h**)，双击打开后，在编辑器的左下角选择 **Configuration Wizard**，进入图形配置界面：

![cmsis_pack_7](../../images/microboot/cmsis-pack/step-07.png)
...
![cmsis_pack_8](../../images/microboot/cmsis-pack/step-08.png)

在usart.c中，添加data_msg_t的定义

![cmsis_pack_9](../../images/microboot/cmsis-pack/step-09.png)

打开串口接收数据中断

![cmsis_pack_10](../../images/microboot/cmsis-pack/step-10.jpg)

在中断接收回调函数中，发射信号：

![cmsis_pack_11](../../images/microboot/cmsis-pack/step-11.jpg)

实现一个串口发送接口：

![cmsis_pack_12](../../images/microboot/cmsis-pack/step-12.jpg)
...
![cmsis_pack_13](../../images/microboot/cmsis-pack/step-13.png)



使用 Xshell等带有Ymodem协议的串口助手，来下载文件：

![cmsis_pack_14](../../images/microboot/cmsis-pack/step-14.jpg)

![cmsis_pack_15](../../images/microboot/cmsis-pack/step-15.jpg)

或者直接使用MicroLink进行下载，MicroLink内置Ymodem协议，将需要升级的bin文件，直接拷贝到虚拟U盘中，即可自动完成下载。

![cmsis_pack_16](../../images/microboot/cmsis-pack/step-16.png)
...
![cmsis_pack_17](../../images/microboot/cmsis-pack/step-17.png)
...
![cmsis_pack_18](../../images/microboot/cmsis-pack/step-18.jpg)
