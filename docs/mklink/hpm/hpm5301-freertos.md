...
!!! info "后续开发版采样验证"
    本文原有工程和截图保留。2026-09-12 新增的三档 mem_dump 验证使用另一组目标镜像与测试固件，见[HPM5301 三档采样](mem-dump-profiles.md)，不要混用两组地址、固件摘要或采样数据。
...
![HPM5301 工程文件配置](../../images/mklink/cases/hpm5301/web-config-files.png)

![HPM5301 本地设备配置](../../images/mklink/cases/hpm5301/web-config-device.png)
...
![HPM5301 在线烧录参数](../../images/mklink/cases/hpm5301/online-flash-ready.png)
...
![HPM5301 在线烧录成功](../../images/mklink/cases/hpm5301/online-flash-succeeded.png)
...
![HPM5301 RTT 运行日志](../../images/mklink/cases/hpm5301/rtt-view-running.png)
...
![HPM5301 SuperWatch PID 曲线](../../images/mklink/cases/hpm5301/superwatch-pid-running.png)
...
![HPM5301 PID 在第三方 VOFA+ 中的实测曲线](../../images/mklink/cases/hpm5301/vofa-plus-pid-step.png)

VOFA+ 适合已有数据引擎、触发和游标工作流的工程师；按符号浏览和在线写参时优先使用 SuperWatch。连接方法和停止命令见 [VOFA+ 第三方上位机](../observation/vofa.md)。

## 7. Memory 核对原始 RAM

在符号表中确认地址后，从 `0x000848D8` 读取 32 字节，覆盖 `pid_kp/pid_ki/pid_kd` 和相邻运行变量。

![HPM5301 PID 参数原始 RAM](../../images/mklink/cases/hpm5301/memory-pid-ram.png)
...
![HPM5301 FreeRTOS SystemView](../../images/mklink/cases/hpm5301/systemview-freertos-running.png)
...
![HPM5301 RISC-V Trap RAM 现场](../../images/mklink/cases/hpm5301/riscv-trap-memory.png)

![HPM5301 Trap 符号地址](../../images/mklink/cases/hpm5301/riscv-trap-symbols.png)
...
![HPM5301 ROM API 脱机预览](../../images/mklink/cases/hpm5301/offline-rom-api-preview.png)
...
![HPM5301 脱机触发成功](../../images/mklink/cases/hpm5301/offline-trigger-succeeded.png)
...
相关专题：[先楫生态](overview.md) · [在线烧录](../flashing/online-flash.md) · [脱机下载](../flashing/offline-flash.md) · [SuperWatch](../observation/superwatch.md) · [HardFault / RISC-V Trap](../debugging/hardfault.md)
