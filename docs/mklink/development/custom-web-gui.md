...
![电池系统 SWD 测试台示意](../../images/mklink/custom-gui/battery-swd-console.png)
...
![FOC SuperWatch 调试台示意](../../images/mklink/custom-gui/foc-superwatch-console.png)
...
![生产烧录与终检工作站示意](../../images/mklink/custom-gui/production-test-station.png)
...
下一步可以回到 [连接硬件与配置工程](../getting-started/project-config.md)，也可以先阅读 [RTT 终端与曲线](../observation/rtt.md) 和 [SuperWatch 与 PID 调试](../observation/superwatch.md)，确定企业页面需要复用的数据能力。
