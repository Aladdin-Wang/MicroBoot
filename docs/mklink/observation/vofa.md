...
![从 MAP 中确认变量地址](../../images/mklink/vofa/vofa-map.png)
...
![VOFA+ 1.3.10 通过 MKLink 显示变量曲线](../../images/mklink/vofa/vofa.png)
...
完整 HPM 操作见 [HPM5301 + FreeRTOS 全功能实战](../hpm/hpm5301-freertos.md)。
