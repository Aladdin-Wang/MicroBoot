...
![](../../images/mklink/legacy-comparisons/segger-jlink.png)

- 盗版检测：the connected probe appears to be a j-link clone

![](../../images/mklink/legacy-comparisons/jlink-clone-message.png)

- 连接故障：The connected J-Link is defective

![](../../images/mklink/legacy-comparisons/jlink-defective-message.png)
...
![](../../images/mklink/legacy-comparisons/jlink-download.jpg)

**MicroLink测试结果：**

![](../../images/mklink/legacy-comparisons/microlink-download.jpg)

下载过程中CLK的时钟波形：

![](../../images/mklink/debugging/swd-clock-waveform.jpg)
...
![](../../images/mklink/communication/uart-10m-baud.jpg)

使用逻辑分析仪抓取波形如图所示，每个bit传输的时间为1/10M=100ns。

![](../../images/mklink/communication/uart-10m-waveform.jpg)
...
![RTTView](../../images/mklink/rtt/rtt-view.jpg)
...
![](../../images/mklink/flashing/stm32f4-flm-selection.jpg)
...
![](../../images/mklink/flashing/flm-converter.png)
...
- **指令下载**
  ...
  ![](../../images/mklink/flashing/load-bin.png)
